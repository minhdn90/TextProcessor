...
public class MainApp extends Application {
    ...
    public void showLoadFileDialog(AutoSpellingTextArea ta) {
    	try {
			...
			FXMLLoader loader = new FXMLLoader(MainApp.class.getResource("view/LoadPDFLayout.fxml"));
		    ...
		    this.pdfAnnotator = controller.getAnnotator();
		    this.pdfDoc = controller.getPDFDoc();
		    this.filePath = controller.getFilePath();
	...
	public void setAnnotatorAndPDFDoc(PDFTextAnnotator a, PDDocument doc){
		pdfAnnotator = a;
		pdfDoc = doc;
	}
	...
	public String getOutputFilePath(){
		return filePath.subSequence(0, filePath.lastIndexOf(".pdf")) + "-hightlighted.pdf";
	}
}
